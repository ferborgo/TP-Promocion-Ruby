...
users = User.create([
  {email: 'admin@admin.com', is_admin: true, first_name: 'Admin', last_name: 'Admin', username: 'Admin'},
  {email: 'example@gmail.com', is_admin: false, first_name: 'Juan', last_name: 'Pérez', username: 'juanperez'}
])
